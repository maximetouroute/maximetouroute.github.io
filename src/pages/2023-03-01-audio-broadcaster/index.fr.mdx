...
subtitle: Diffusion Audio temps-réel
tags: software
...
### Accès sur demande à [contact@maximetouroute.com](mailto:contact@maximetouroute.com)
...
* Audiodescription live, accessibilité
* Visites guidées
* Parcours sonores
* Concerts silencieux
* Diffusions sonores à distance
* Art sonore, créations originales
* Une autre idée ? [Dites le nous !](mailto:contact@maximetouroute.com)
